...
const { findPosts, createPost, findTimeline, findLikedPosts, findSavedPosts, addLikePost, removeLikePost, removeRepostPost, addRepostPost, addSavePost, removeSavePost } = require('../../controllers/postController');
